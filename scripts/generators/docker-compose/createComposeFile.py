...
defaultValues = {
    ...
    # changed by the user.
    "_defaultDefaultPorts": {"services": 8080, "databases": 5432, "loaders": 6000},
}
...
def main():
    ...
    if isinstance(yaml_data, dict):
        ...
        raise Exception(
            f"Failed to read the configuration file {config_path}: The top-level structure is not a dictionary."
        )
